...
map_file = "log_folder_tree/" + "map_gd2.csv"
inputs = []
outputs = []
plot_folder = "plots/"
...
while len(l)>1:
  ...
  if os.path.isfile(OUTPUT_FILE):
    with open(OUTPUT_FILE) as json_file:
      ...
      file_wo_ext = input_param["graph"] + '_' + input_param["graph_param_2"] + ".png"
